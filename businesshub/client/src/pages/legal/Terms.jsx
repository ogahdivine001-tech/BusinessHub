...
export default function Terms() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
      <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-ink-900 dark:text-white">Terms of Service</h1>
      ...
      <div className="mt-8 rounded-xl bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-900/40 px-4 py-3 text-sm text-amber-800 dark:text-amber-300">
        This document is a general-purpose draft covering how BusinessHub operates. It isn't a substitute for advice from a qualified Nigerian lawyer — we'd recommend a legal review before treating it as final, especially given real payments and customer data are involved.
      </div>
