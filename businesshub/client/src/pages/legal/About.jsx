  ...
  return (
    <div>
      <section className="max-w-4xl mx-auto px-4 sm:px-6 pt-16 pb-12 text-center">
        <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-ink-900 dark:text-white">About BusinessHub</h1>
        <p className="text-lg text-ink-600 dark:text-ink-400 mt-5 max-w-2xl mx-auto">
      ...
      <section className="bg-ink-50 dark:bg-ink-900/40 py-16">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {VALUES.map((v) => (
              <div key={v.title} className="card p-6">
                ...
                <p className="text-sm text-ink-500 dark:text-ink-400">{v.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 py-16 text-center">
        ...
        <p className="text-ink-500 dark:text-ink-400 mt-3">Join business owners already growing with BusinessHub — free to start.</p>
