        ...
        <div className="card p-7">
          {sent ? (
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500 mt-2">If an account exists for {email}, we've sent password reset instructions.</p>
            ...
            <>
              ...
              <p className="text-sm text-gray-500 text-center mt-1">We'll send you a reset link</p>
